                        ...
                        <tbody>
                            ...
                            @foreach ($data_siswa_aktif as $siswa_aktif)
                                <tr>
                                    ...
                                    <td>{{ $siswa_aktif->sakit || $siswa_aktif->sakit == '0' ? $siswa_aktif->sakit : '-' }}
                                    </td>
                                    <td>{{ $siswa_aktif->izin || $siswa_aktif->izin == '0' ? $siswa_aktif->izin : '-' }}
                                    </td>
        ...
        <div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form id="form-edit" class="modal-content" action="" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Ubah <span
                                class="text-primary">Ketidakhadiran</span>
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" required class="form-control @error('sakit') is-invalid @enderror"
                                id="sakit" name="sakit" value="">
                            @error('sakit')
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" required class="form-control @error('izin') is-invalid @enderror"
                                id="izin" name="izin" value="">
                            @error('izin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" required
                                class="form-control @error('tanpa_keterangan') is-invalid @enderror" id="tanpa_keterangan"
                                name="tanpa_keterangan" value="">
                ...
                <form class="modal-content" action="{{ route('admin.ketidakhadiran.import') }}" method="post"
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-2">
                            ...
                            <input type="file" class="form-control" required id="excel"
                                name="data_ketidakhadiran" accept=".xlsx, .xls">
                            <div class="text-small text-danger mt-2">
                                * Mohon masukkan data dengan benar sebelum dikirim
                            </div>
                            <a href="{{ route('admin.ketidakhadiran.export_format') }}"
        ...
        <div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <form id="form-edit" class="modal-content" action="" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Edit <span
                                class="text-primary">Ketidakhadiran</span>
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
