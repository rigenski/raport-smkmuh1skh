      ...
      @if(count($data_raport_p5_projek))
        @foreach($data_raport_p5_projek as $raport_p5_projek)
          <div id="form-clone" class="mb-2 col-12 col-md-6">
            <input type="hidden" name="id[]" value={{ $raport_p5_projek->id}}>value
    ...
    <div class="row px-3">
      ...
      <div class="col-12 col-sm-6 p-0 my-1">
        <div class="d-flex justify-content-end">
          <a href={{ route('admin.raport_p5') }} type="button" class="btn mr-2 btn-warning">Kembali</a>
          <a href={{ route('admin.raport_p5.dimensi') }} type="button" class="btn btn-primary">Selanjutnya</a>
        </div>
      </div>
    </div>
  </div>
