                            ...
                            @if ($filter->has('jenis'))
                                ...
                                @foreach ($data_jenis_mata_pelajaran as $jenis_mata_pelajaran)
                                    @if ($filter->jenis !== $jenis_mata_pelajaran->jenis)
                                        <option value="{{ $jenis_mata_pelajaran->jenis }}">
                                            {{ $jenis_mata_pelajaran->jenis }}</option>
                                    @endif
                                @endforeach
                            @else
                                @foreach ($data_jenis_mata_pelajaran as $jenis_mata_pelajaran)
                                    <option value="{{ $jenis_mata_pelajaran->jenis }}">{{ $jenis_mata_pelajaran->jenis }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
    ...
    <div class="modal fade" id="modal-edit" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form id="form-edit" class="modal-content" action="" method="post">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Ubah <span class="text-primary"> Mata
                            Pelajaran</span>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" required class="form-control @error('jenis') is-invalid @enderror"
                            id="jenis" name="jenis" value="">
                        @error('jenis')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control @error('urutan') is-invalid @enderror" autocomplete="off"
                            name="urutan" required>
                            <option value="" id="urutan"></option>
                            @for ($i = 1; $i <= count($data_mata_pelajaran); $i++)
